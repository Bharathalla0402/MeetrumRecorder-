...
//        myVC?.strTitle = (UserDefaults.standard.object(forKey: "title") as? String)!
//        myVC?.strDescrip = (UserDefaults.standard.object(forKey: "des") as? String)!
//        myVC?.strWeblink = (UserDefaults.standard.object(forKey: "link") as? String)!
//        myVC?.strtypeId = (UserDefaults.standard.object(forKey: "id") as? String)!
    ...
    func closeMenu(){
        ...
        UIView.animate(withDuration: 0.7, delay: 0.0, options: UIViewAnimationOptions.beginFromCurrentState, animations: { () -> Void in
         ...
         //   let appDelegate = UIApplication.shared.delegate as! AppDelegate
            self.mainContainer!.view.frame = CGRect(x: 0, y: 0, width: self.view.frame.size.width, height: self.view.frame.size.height)
            }) { (finished: Bool) -> Void in
